...
class test_expressions(unittest.TestCase):
    ...
    def test_postfix_eval_01e(self) -> None:
        self.assertAlmostEqual(postfix_eval("8 2 3 + *"), 40)

    def test_postfix_eval_01f(self) -> None:
        self.assertAlmostEqual(postfix_eval("10 4 %"), 2)
    ...
    def test_postfix_eval_05b(self) -> None:
        try:
            postfix_eval("5 0 //")
            self.fail()     # pragma: no cover
        except PostfixFormatException as e:
    ...
    def test_postfix_eval_06(self) -> None:
        try:
            ...
            self.assertEqual(str(e), "llegal bit shift operand")

    def test_postfix_eval_06b(self) -> None:
        try:
            postfix_eval("5.3 2.8 >>")
            self.fail()     # pragma: no cover
        except PostfixFormatException as e:
            self.assertEqual(str(e), "llegal bit shift operand")
